...
In this chapter we learned how to do simple math in R, how to assign variables, write/save scripts, and use functions.  As we now know how to do some simple stuff in R, in the next chapters we will transition towards doing useful stuff in R.  
:::
