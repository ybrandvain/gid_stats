...
The **Drake equation** states $${\displaystyle N=R_{*} \times f_{\mathrm {p} }\times n_{\mathrm {e} }\times f_{\mathrm {l} }\times f_{\mathrm {i} }\times f_{\mathrm {c} }\times L}$$
where:  
...
Now that you have R and RStudio installed, you should be ready to learn how to do things in R in prepration or doing usefull things in R! 